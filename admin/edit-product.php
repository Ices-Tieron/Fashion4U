<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['product_image']) && $_FILES['product_image']['error'] == 0) {
      ...
      $new_image_url = "images/" . $file_name;
      ...
      <div class="row mb-3">
        <div class="col-md-6">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="subcategory" name="subcategory" value="<?php echo $product['subcategory']; ?>" required>
          </div>
        ...
        <div class="col-md-6">
            ...
            <div class="row g-2">
              <div class="col-4">
                <div class="input-group mb-2">
                  ...
                  <input type="number" class="form-control" name="price_xs" step="0.01" min="0" value="<?php echo $product['price_xs']; ?>">
                </div>
              </div>
              <div class="col-4">
                <div class="input-group mb-2">
                  <span class="input-group-text">S ₵</span>
                  <input type="number" class="form-control" name="price_s" step="0.01" min="0" value="<?php echo $product['price_s']; ?>">
                </div>
              </div>
              <div class="col-4">
                <div class="input-group mb-2">
                  <span class="input-group-text">M ₵</span>
                  <input type="number" class="form-control" name="price_m" step="0.01" min="0" value="<?php echo $product['price_m']; ?>">
                </div>
              </div>
              <div class="col-4">
                <div class="input-group mb-2">
                  <span class="input-group-text">L ₵</span>
                  <input type="number" class="form-control" name="price_l" step="0.01" min="0" value="<?php echo $product['price_l']; ?>">
                </div>
              </div>
              <div class="col-4">
                <div class="input-group mb-2">
                  <span class="input-group-text">XL ₵</span>
                  <input type="number" class="form-control" name="price_xl" step="0.01" min="0" value="<?php echo $product['price_xl']; ?>">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <select class="form-select" id="size" name="size">
                  ...
                  <option value="one-size" <?php echo ($product['size'] == 'one-size') ? 'selected' : ''; ?>>One Size</option>
                </select>
              </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <select class="form-select" id="gender" name="gender">
                  ...
                  <option value="boys" <?php echo ($product['gender'] == 'boys') ? 'selected' : ''; ?>>Boys</option>
                  <option value="girls" <?php echo ($product['gender'] == 'girls') ? 'selected' : ''; ?>>Girls</option>
            ...
            <div class="col-md-6">
              <div class="mb-3">
                ...
                <select class="form-select" id="age_group" name="age_group">
                  ...
                  <option value="adult" <?php echo ($product['age_group'] == 'adult') ? 'selected' : ''; ?>>Adult</option>
                  <option value="teen" <?php echo ($product['age_group'] == 'teen') ? 'selected' : ''; ?>>Teen</option>
                  <option value="kid" <?php echo ($product['age_group'] == 'kid') ? 'selected' : ''; ?>>Kid</option>
                  <option value="baby" <?php echo ($product['age_group'] == 'baby') ? 'selected' : ''; ?>>Baby</option>
                </select>
              </div>
            </div>
          </div>
          ...
          <div class="mb-3">
            <div class="form-check">
              <input class="form-check-input" type="checkbox" id="featured" name="featured" <?php echo ($product['featured'] == 1) ? 'checked' : ''; ?>>
          ...
          <div class="mb-3">
            ...
            <?php if (!empty($product['image_url'])): ?>
              <div class="mt-2">
                ...
                <img src="../<?php echo $product['image_url']; ?>" alt="<?php echo $product['name']; ?>" class="img-thumbnail" style="max-width: 200px; max-height: 200px;">
              </div>
            <?php endif; ?>
          </div>
        </div>
